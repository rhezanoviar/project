...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Pustaka Validasi dan lain-lain
    |--------------------------------------------------------------------------
    |
    | Perintah dan pesan untuk validasi
    |
    */
    ...
    'alpha_dash' => 'Hanya boleh berisi angka, huruf, tanda hubung, dan garis bawah.',
    'alpha_num' => 'Hanya boleh berisi huruf dan angka.',
    'array' => 'Harusbe rupa array.',
    ...
    'confirmed' => 'The :tidak cocok.',
    'current_password' => 'Kata sandi tidak valid.',
    'date' => 'Tanggal tidak valid.',
    'date_equals' => 'Tanggal harus sama dengan :date.',
