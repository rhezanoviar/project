                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush datatable-buttons">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="students">Jumlah Siswa</th>
                                ...
                                @foreach ($subjects as $subject)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!--/ Update Class Modal -->
                                            <a href="{{ route('subject.show', $subject) }}" class="btn btn-sm bg-blue-500 text-white m-0 radius" title="Lihat">
                                                <i class="fas fa-eye" aria-hidden="true"></i>
                                            </a>
                                            <a href="{{ route('subject.assign-student', $subject) }}" class="btn btn-sm bg-yellow-500 text-white m-0 radius" title="Tambahkan Siswa">
                                                <i class="fas fa-users-class" aria-hidden="true"></i>
                                            </a>
                                            <form action="{{ route('subject.destroy', $subject) }}" class="d-inline" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button onclick="return confirm('Yakin menghapus mata pelajaran ini?')" type="submit" class="btn btn-sm bg-red-500 text-white radius" title="Hapus">
