                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body text-center bg-white-100 radius shadow-2xl">
                            <h2 class="mt-4">Attendance for : {{ $subject->name }}</h2>
                            ...
                            <hr>
                            <div class="text-left">
                                <h2 class="mb-3 text-bold">Daftar Siswa</h2>
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    ...
                                                    <div class="custom-control custom-radio d-inline">
                                                        ...
                                                        <label class="custom-control-label" for="radio-{{ $student->id }}-off">Absen</label>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
