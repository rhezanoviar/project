...
class SubjectController extends BaseController
{
    ...
    public function index(){
        $this->setPageTitle('Mata Pelajaran', 'Mata Pelajaran');
        $users = User::all();
    ...
    public function assignStudents(Subject $subject){
        $this->setPageTitle($subject->name, 'Tambahkan Siswa');
    ...
    public function detachAssignedStudent(Subject $subject, Student $student): RedirectResponse
    {
        ...
        alert('Bagus!', $student->name . ' Berhasil Dihapus', 'success');
        // Redirect Back
    ...
    public function destroy(Subject $subject): RedirectResponse
    {
        ...
        // Show Sweet Alert Notification
        alert('Bagus!', 'Berhasil Dihapus', 'success');
        // Redirect Back
        return redirect()->back();
    }
}
